...
draft: false
type: blog
image: https://cdn.suuny0826.com/large/ad5fbf65gy1gi34sbradjj20ge091wh0.jpg
---
## 前言

今天是七夕节，但对我来时只是”平凡“的一天，上午认识的一个阿里云的小姐姐给我发来一个可疑链接，说是有好玩的活动，推荐我参加一下。于是在午休时间，闲来无事的我点开了这个链接，没想到事情并不简单。

![](https://cdn.suuny0826.com/large/ad5fbf65gy1gi34yex8kgj20al05qmxm.jpg)
...
![](https://cdn.suuny0826.com/large/ad5fbf65gy1gi352mu9k4j212w0q0wmi.jpg)
...
![活动页](https://cdn.suuny0826.com/large/ad5fbf65gy1gi359oqgh9j21h20q97a5.jpg)
...
![云效 DevOps](https://cdn.suuny0826.com/large/ad5fbf65gy1gi35ntu6avj212m0k2dgv.jpg)

### 修改情书内容

编辑代码修改情书内容，地址`app/service/data.js`：

![修改内容](https://cdn.suuny0826.com/large/ad5fbf65gy1gi35q45ru3j21hc0pfmy3.jpg)

可以修改以下字段来实现内容的定制：

- `theme`：情书模板，提供了爱人、朋友、同事三种模板，如下所示：

![爱人、朋友、同事](https://cdn.suuny0826.com/large/ad5fbf65gy1gi35sch68xj210g0jb0xy.jpg)
...
![保存](https://cdn.suuny0826.com/large/ad5fbf65gy1gi35y8l234j20fe0880sw.jpg)

### 配置流水线

代码写好了，现在就可以使用流水线将情书的 H5 发布出去了。点击左上角九宫格，选择 `流水线` - `新建流水线`，选择模板：`其他` - `云效七夕活动`

![选择模板](https://cdn.suuny0826.com/large/ad5fbf65gy1gi362uhnv8j21hc0pfmye.jpg)

之后就可以配置流水线了，点击 `添加代码源`，选择 `云效Codeup` 代码源，选择刚刚克隆的 `letter` 代码库，选择 `master` 分支，开启 `代码源触发`

![image](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36917of6j21h70q7wie.jpg)
...
![连接 Kubernetes](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36dhtzfxj21070jgt9j.jpg)
...
![其他配置](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36f8xxffj20w70icdgb.jpg)

完成所有配置后，点击 `保存并运行` - `运行`：

![](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36hajgyuj20fd08s746.jpg)

### 修复问题

这里为了让用户体验质量卡点 `JavaScript 单元测试` 功能，他们还在项目中埋了一个小坑，让首次构建失败，原因是：测试通过率小于100%

![质量卡点](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36jr1kwjj21090a7t9h.jpg)

查看报错信息，发现是 `expect` 值被设置为 `400`： 

![报错信息](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36k3n45mj212g0e4tad.jpg)

进入对应的单元测试文件，修改代码：

![修复问题](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36md5twaj21h40pzn10.jpg)

修改完成后，点击 `保存` - `提交`，由于之前设置了流水线 `提交源代码触发`，流水线在提交后会自动触发，并发布成功：

![发布成功](https://cdn.suuny0826.com/large/ad5fbf65gy1gi36npelasj210109l3zc.jpg)
